    ...
    public partial class FrmExecute : Form
    {
        ...
        private void cmdExecute_Click(object sender, EventArgs e)
        {
            ...
            if (con.State == ConnectionState.Open)
            {
                ...
                {
                    string cmd = "set pgpassword=" + pass.Text + "& pg_dump  -h localhost -p  5433 " + " -U " + user.Text + " " + dbname.Text + " > " + dir.Text + "";
                    //cmd += "\"" + txtFile.Text + "\" postgresql://postgres:alaa@localhost";
                    try
                    {
